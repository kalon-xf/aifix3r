...
test("D1 migration creates the operational schema and indexes", () => {
  ...
  for (const table of ["programs", "scopes", "jobs", "assets", "job_results", "findings", "evidence", "finding_validations", "reports"]) assert.ok(tables.includes(table), `${table} table missing`);
